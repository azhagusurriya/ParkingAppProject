...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private String keyapi = "AIzaSyAF_LRZFL17vGY2azxU7Aie8qSKpukx7a8";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent t = getIntent();
        parkings = (Parkings) t.getSerializableExtra("SelectedParking");
...
//        fetchLocation();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng latLng2=new LatLng(parkings.getLatitude(),parkings.getLongitude());
    ...
    private String getDirectionsUrl(LatLng origin, LatLng dest) {
        ...
        String key = "key=AIzaSyAF_LRZFL17vGY2azxU7Aie8qSKpukx7a8";
